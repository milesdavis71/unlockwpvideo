        ...
        <div class="one-third">
          ...
          ${
            results.programs.length
              ? '<ul class="link-list min-list">'
              : `<p>No program information matches that search. <a href="${universityData.root_url}/programs">View all programs</a></p>`
          }
          ${results.programs
            .map(
        ...
        <div class="one-third">
          ...
          ${
            results.campuses.length
              ? '<ul class="link-list min-list">'
              : `<p>No general campuses match that search. <a href="${universityData.root_url}/campuses">View all campuses</a></p>`
          }
          ${results.campuses
            .map(
              (item) => `<li><a href="${item.permalink}">${item.title}</a></li>`
  ...
  addSearchHTML() {
    ...
    <div class="search-overlay__top">
        <div class="container">
            ...
            <input type="text" class="search-term" placeholder="Mit keresel?" id="search-term">
        </div>
    </div>
    <div class="container">
