...
?>
    <div class="container container--narrow page-section">
        <div class="metabox metabox--position-up metabox--with-home-link">
            <p><a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('event') ?>"><i class="fa fa-home" aria-hidden="true"></i>
                    Event Home</a> <span class="metabox__main"><?php the_title() ?></span></p>
        </div>
        ...
        if ($relatedPrograms) {
            ...
            echo '<h2 class="headline headline--medium">Related progam(s)</h2>';
    ...
    <div><?php $image = get_field('page_banner_image');
            echo $image ?></div>
